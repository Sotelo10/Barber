      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center justify-between">
          {team.map((member, index) => (
            <Card key={index} className="flex flex-col md:flex-row w-full max-w-full mx-auto p-6 bg-white shadow-lg rounded-lg hover:shadow-2xl transition-all duration-300">
              
              {/* Contenedor de la imagen con tamaño flexible */}
              <div className="relative w-full h-72 md:w-[50%] md:h-[500px] rounded-lg overflow-hidden mb-6 md:mb-0">
                <Image
                  src={member.image}
                  alt={member.name}
                  layout="fill"
              ...
              <CardContent className="w-full md:w-[50%] md:pl-8">
